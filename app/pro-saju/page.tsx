...
<div className="mx-2 bg-white rounded-xl shadow-sm overflow-hidden border border-gray-200 mb-2">
    ...
    {COLS.map((col) => {
      ...
      return (
        <div key={`stem-${col}`}
          ...
          {/* 십성 라벨(조금 더 크게) */}
          <span className="mb-1 text-xs font-bold text-indigo-700">
            {ganSibsung}
          </span>
  ...
  <div className="grid grid-cols-4 border-b border-gray-100 bg-white">
    {COLS.map((col) => {
      ...
      return (
        <div key={`ji-sibsung-${col}`}
          className="py-1 flex items-center justify-center border-r last:border-r-0 border-gray-100">
  ...
  <div className="grid grid-cols-4 bg-white">
    {COLS.map((col) => {
      ...
      return (
        <div key={`twelve-${col}`}
          className="py-1 flex items-center justify-center border-r last:border-r-0 border-gray-100">
          <span className="inline-block px-2 py-0.5 rounded-full bg-indigo-600 text-white text-xs font-semibold">
            {star}
          </span>
        </div>
      );
                  ...
                  {debugData.finalResult.daeWoonYear.map((startYear, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          className={`w-10 h-10 mb-1 flex items-center justify-center text-xl font-bold text-white rounded ${sStyle.bg}`}
                        >
                          {s}
                        </div>
                        <div
                          className={`w-10 h-10 flex items-center justify-center text-xl font-bold text-white rounded ${bStyle.bg}`}
                        >
                          {b}
                        </div>
                      </div>
                  ...
                  {seunList.map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          className={`w-10 h-10 mb-1 flex items-center justify-center text-xl font-bold text-white rounded shadow-sm ${sStyle.bg}`}
                        >
                          {s}
                        </div>
                        <div
                          className={`w-10 h-10 flex items-center justify-center text-xl font-bold text-white rounded shadow-sm ${bStyle.bg}`}
                        >
                          {b}
                        </div>
                  ...
                  {wolunList.map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          className={`w-9 h-9 mb-1 flex items-center justify-center text-lg font-bold text-white rounded shadow-sm ${sStyle.bg}`}
                        >
                          {s}
                        </div>
                        <div
                          className={`w-9 h-9 flex items-center justify-center text-lg font-bold text-white rounded shadow-sm ${bStyle.bg}`}
                        >
                          {b}
                        </div>
                      </div>
